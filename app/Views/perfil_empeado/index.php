...
<div class="app-hero-header d-flex align-items-center">
          <div class="d-flex align-items-center">
            ...
            <div>
              <h2 class="mb-1">Perfil del Empleado</h2>
              <h6 class="m-0 text-dark fw-light">Información personal</h6>
            </div>
          </div>
        </div>
        <div class="text-center text-muted small mb-2">Datos visibles solo para Empleado.</div>
<?= $this->endSection() ?>
                  ...
                  <form id="infoForm" onsubmit="return false;">
                    <div class="row g-4 align-items-start">
                      <div class="col-md-3 d-flex flex-column align-items-start gap-3">
                        <img id="avatarPreview" class="rounded-circle" src="<?= base_url('public/img/emple1.png') ?>" alt="Avatar" style="width:200px;height:200px;object-fit:cover;border:4px solid #fff;box-shadow:0 6px 18px rgba(0,0,0,0.15);background:#f3f4f6;">
                      </div>
                      <div class="col-md-9">
                        <div class="row g-3">
                      <div class="col-md-6">
