 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.3.4/b-3.2.5/r-3.0.7/sc-2.4.3
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.4, Buttons 3.2.5, Responsive 3.0.7, Scroller 2.4.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/jq-3.7.0/dt-2.3.4/b-3.2.5/r-3.0.7/sc-2.4.3",
